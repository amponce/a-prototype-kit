...
import ModelSelectionTab from '~/components/@settings/tabs/models/ModelSelectionTab';
...
const TAB_DESCRIPTIONS: Record<TabType, string> = {
  ...
  'model-selection': 'Choose AI models and providers for chat',
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                  <div className="flex items-center space-x-4">
                    {(activeTab || showTabManagement) && (
                      <button
                        onClick={handleBack}
                        className="flex items-center justify-center w-8 h-8 rounded-full bg-transparent hover:bg-blue-600/10 dark:hover:bg-blue-600/20 group transition-all duration-200"
                      >
