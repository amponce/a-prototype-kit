                ...
                <div className="bg-[#F9F9F9] dark:bg-[#252525] p-4 rounded-lg space-y-3">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-3">
                    ...
                    <button
                      ...
                      className="w-full py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                    >
          ...
          <Dialog.Content className="fixed top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-[90vw] md:w-[600px] max-h-[85vh] overflow-hidden bg-white dark:bg-[#1A1A1A] rounded-xl shadow-xl z-[51] border border-[#E5E5E5] dark:border-[#333333]">
            ...
            <div className="p-4 border-b border-[#E5E5E5] dark:border-[#333333] flex items-center justify-between">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-sm transition-colors flex items-center gap-1.5"
              >
                    ...
                    {selectedRepository ? (
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <button
                            onClick={handleImport}
                            className="w-full h-10 px-4 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition-all duration-200 flex items-center gap-2 justify-center"
                          >
  ...
  return (
    <div className="p-4 rounded-lg bg-bolt-elements-background-depth-1 border border-bolt-elements-borderColor hover:border-bolt-elements-borderColorActive/70 transition-colors">
      <div className="flex items-center justify-between mb-2">
        ...
        <button
          onClick={onSelect}
          className="px-4 py-2 h-10 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition-all duration-200 flex items-center gap-2 min-w-[120px] justify-center"
        >
