            ...
            <Collapsible open={isStatsExpanded} onOpenChange={setIsStatsExpanded}>
              ...
              <CollapsibleContent className="overflow-hidden">
                <div className="space-y-4 mt-4">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-lg font-medium text-bolt-elements-textPrimary">Connect to GitHub</h3>
                    <div className="p-3 rounded-lg bg-bolt-elements-background-depth-0 border border-bolt-elements-borderColor">
                      <div className="flex items-start gap-2">
                        ...
                        <div className="text-sm text-bolt-elements-textSecondary">
                          <p>
                            <strong>Template Access:</strong> Starter templates can be accessed without a personal
                            GitHub token.
                          </p>
