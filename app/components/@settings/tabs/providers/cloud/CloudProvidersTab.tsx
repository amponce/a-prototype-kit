            ...
            >
              <div className="absolute top-0 right-0 p-2 flex gap-1">
                {URL_CONFIGURABLE_PROVIDERS.includes(provider.name) && (
                  <motion.span
                    className="px-2 py-0.5 text-xs rounded-full bg-blue-600/10 text-purple-500 font-medium"
              ...
              <div className="flex items-start gap-4 p-4">
                ...
                <div className="flex-1 min-w-0">
                      ...
                      {envVarStatuses[provider.name]?.hasBaseUrl && (
                        <div className="mt-2 text-xs text-green-500">
                          <div className="flex items-center gap-1">
                            ...
                            <span>Environment URL found in .env file</span>
                          </div>
                        </div>
                      )}
                    </motion.div>
                  ...
                  {provider.settings.enabled && providerBaseUrlEnvKeys[provider.name]?.apiTokenKey && (
                    <motion.div
                      initial={{ opacity: 0, height: 0 }}
                      animate={{ opacity: 1, height: 'auto' }}
                      exit={{ opacity: 0, height: 0 }}
                      ...
                      className="mt-2"
                    >
                      {envVarStatuses[provider.name]?.hasApiKey && (
                        <div className="text-xs text-green-500">
                          <div className="flex items-center gap-1">
                            <div className="i-ph:key" />
                            <span>API key found in .env file</span>
                          </div>
                        </div>
                      )}
                    </motion.div>
