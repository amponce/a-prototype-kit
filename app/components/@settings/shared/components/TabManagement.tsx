...
const BetaLabel = () => (
  <span className="px-1.5 py-0.5 text-[10px] rounded-full bg-blue-600/10 text-purple-500 font-medium">BETA</span>
);
            ...
            .map((tab, index) => (
              ...
              >
                ...
                <div className="absolute top-1 right-1.5 flex gap-1">
                  <span className="px-1.5 py-0.25 text-xs rounded-full bg-blue-600/10 text-purple-500 font-medium mr-2">
                    Default
                  </span>
                </div>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-4">
                      ...
                      <Switch
                        ...
                        className={classNames('data-[state=checked]:bg-blue-600 ml-4', {
