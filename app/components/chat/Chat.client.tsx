...
export const ChatImpl = memo(
  ({ description, initialMessages, storeMessageHistory, importChat, exportChat }: ChatProps) => {
    ...
    }, [selectedModel, selectedProvider, searchParams]);
    ...
    const sendMessage = async (_event: React.UIEvent, messageInput?: string) => {
      ...
      // Force the animation to run first
      await runAnimation();

      if (!chatStarted) {
        console.log('Chat not started yet, initializing with first message');
        setFakeLoading(true);
    ...
    const handleProviderChange = (newProvider: ProviderInfo) => {
      updateSelectedProvider(newProvider.name);
    };
