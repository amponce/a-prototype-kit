        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
          <div className="p-4 space-y-3">
            <div className="flex gap-2">
              <a
                href="/"
                className="flex-1 flex gap-2 items-center bg-purple-50 dark:bg-blue-600/10 text-purple-700 dark:text-purple-300 hover:bg-purple-100 dark:hover:bg-blue-600/20 rounded-lg px-4 py-2 transition-colors"
              >
              ...
              <button
                ...
                className={classNames(
                  ...
                  selectionMode
                    ? 'bg-purple-600 dark:bg-blue-600 text-white border border-purple-700 dark:border-purple-600'
