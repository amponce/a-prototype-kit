        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
          <div className="p-4 space-y-3">
            <div className="flex gap-2">
              <a
                href="/"
                className="flex-1 flex gap-2 items-center bg-blue-50 dark:bg-blue-600/10 text-blue-700 dark:text-blue-300 hover:bg-blue-100 dark:hover:bg-blue-600/20 rounded-lg px-4 py-2 transition-colors"
              >
              ...
              <button
                ...
                className={classNames(
                  ...
                  selectionMode
                    ? 'bg-blue-600 dark:bg-blue-600 text-white border border-blue-700 dark:border-blue-600'
